...
const TRUSTPILOT_REVIEWS = [
  {
    name: "Sanusan Varathan",
    country: "DE",
    flag: "🇩🇪",
    date: "Apr 23, 2026",
    rating: 5,
    title: "Mega Qualität",
    body: "Krass schnelle Zustellung innerhalb 2 tage und qualität sowie kundenservice sehr gut! Kann man nur weiterempfehlen.",
  },
  {
    name: "Rene",
    country: "DE",
    ...
    body: "Bestellung kam direkt am nächsten Tag an. Bei Fragen wurde einem direkt weitergeholfen. Toller Support 👍🏽",
  },
  {
    name: "Selin Kaygusuz",
    country: "DE",
    ...
    body: "Der Geschäftsführer hat mir nach einem Fehler bei der Adresse ein neues Paket kostenlos zukommen lassen. Super Kundenservice! 🙂",
  },
  {
    name: "DerBuddy",
    country: "DE",
    ...
    body: "Thats the greatest shop i ever seen. To Germany was a 1 Day delivery. Fair prices and great customer service!",
  },
  {
    name: "Werner Gappmaier",
    country: "AT",
    flag: "🇦🇹",
    date: "Feb 6, 2026",
    rating: 5,
    title: "All good",
    body: "All good. Delivery was very fast. Very nice Support.",
  },
  {
    name: "Ben O",
    country: "DE",
    ...
    rating: 4,
    title: "BioSyncLabs",
    body: "Der Shop ist super verständlich aufgebaut, der Support ist gut. Alles in einem top Shop mit guter Qualität.",
  },
  {
    name: "Jose Mora Gasteratos",
    country: "US",
    flag: "🇺🇸",
    date: "Feb 4, 2026",
    rating: 5,
    title: "Sehr guter Shop",
    body: "Der Support ist sehr hilfreich, Bestellungen werden direkt am nächsten oder gleichen Tag verschickt — legitim und vertrauenswürdig.",
  },
  {
    name: "Tobias",
    country: "DE",
    ...
    date: "Jan 3, 2026",
    rating: 5,
    title: "Die besten Preise in Deutschland",
    body: "Die besten Preise in Deutschland in diesem Shop. Werde künftig wieder bestellen.",
  },
  {
    name: "Brigitte Neunmann",
    country: "MX",
    flag: "🇲🇽",
    date: "Jan 2, 2026",
    rating: 5,
    title: "Sehr schnelle Lieferung",
    body: "Am Montag morgen bestellt und am Dienstag schon geliefert worden. Wirklich sehr starke Leistung!",
  },
  {
    name: "Theo Chris",
    country: "DE",
    ...
    date: "Jan 1, 2026",
    rating: 5,
    title: "First order from them",
    body: "Shipping came from Germany and it was super fast — 1 day delivery! Their product was also very HQ. I recommend!",
  },
];
...
export function TrustpilotReviewsSection() {
  ...
  return (
    <section className="overflow-hidden bg-[#f6f7f9] py-14 dark:bg-slate-900">
      {/* Header */}
      <div className="mx-auto mb-10 max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
          {/* Left: headline */}
          <div>
            <p className="mb-1 text-xs font-bold uppercase tracking-widest text-[#00b67a]">
          ...
          {/* Right: Trustpilot score badge */}
          <a
            href="https://www.trustpilot.com/review/biosynclabs.to"
            target="_blank"
            rel="noopener noreferrer"
            className="flex shrink-0 flex-col items-center gap-1 rounded-2xl border border-slate-200 bg-white px-6 py-4 shadow-sm transition-shadow hover:shadow-md dark:border-slate-700 dark:bg-slate-800 sm:items-start"
          >
            {/* Trustpilot wordmark */}
            <div className="flex items-center gap-1.5">
              <svg viewBox="0 0 126 34" className="h-5 w-auto" aria-label="Trustpilot">
                <path
                  d="M17.0 0L20.9 11.8H33.5L23.3 19.1L27.2 30.9L17.0 23.7L6.8 30.9L10.7 19.1L0.5 11.8H13.1L17.0 0Z"
                  fill="#00b67a"
                />
                <text x="40" y="24" fontFamily="system-ui,sans-serif" fontSize="20" fontWeight="700" fill="#191919">
                  Trustpilot
                </text>
              </svg>
            </div>
            <div className="flex items-center gap-2">
              <StarRating rating={5} />
              <span className="text-sm font-bold text-slate-900 dark:text-slate-100">4.6</span>
              <span className="text-sm font-semibold text-[#00b67a]">Excellent</span>
            </div>
            <p className="text-xs text-slate-500 dark:text-slate-400">TrustScore 4.5 · 18 reviews</p>
          </a>
        </div>
      </div>
      ...
      <div
        ...
        style={{ animation: "carousel 60s linear infinite", width: "max-content" }}
      >
        {doubled.map((review, i) => (
          <div
            key={i}
            className="w-[280px] shrink-0 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800 sm:w-[300px]"
          >
            <StarRating rating={review.rating} />

            <p className="mt-3 line-clamp-1 text-sm font-bold text-slate-900 dark:text-slate-100">
              {review.title}
            </p>
            ...
            <div className="mt-4 flex items-center gap-2 border-t border-slate-100 pt-3 dark:border-slate-700">
              ...
              <div className="min-w-0">
                <p className="truncate text-xs font-semibold text-slate-800 dark:text-slate-200">{review.name}</p>
      ...
      <div className="mt-8 flex justify-center">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-full border border-slate-300 bg-white px-5 py-2.5 text-xs font-semibold text-slate-700 shadow-sm transition-all hover:border-[#00b67a] hover:text-[#00b67a] hover:shadow-md dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300"
        >
