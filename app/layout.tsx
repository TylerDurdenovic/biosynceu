...
export const metadata: Metadata = {
  ...
  description:
    "BioSyncLabs — Germany's trusted EU research peptide supplier. Buy BPC-157, TB-500, GHK-Cu, RET-G.L.P.3 and more. Every batch third-party HPLC tested to ≥99% purity. Certificate of Analysis available online. Fast EU shipping, no customs delays.",
  keywords: [
    // Brand
    "BioSyncLabs",
  ...
  openGraph: {
    ...
    description:
      "Germany-based EU research peptide supplier. Buy BPC-157, TB-500, GHK-Cu, RET-G.L.P.3 and more. HPLC-verified ≥99% purity. CoA available online. Fast intra-EU shipping.",
    images: [
      {
        url: "/logo2.png",
        width: 1200,
